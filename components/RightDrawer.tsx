...
const RightDrawer: React.FC<RightDrawerProps> = ({ visible, onClose }) => {
  ...
  const displayModes = [
    { label: "Fit", desc: "Adjust wallpaper to fit your screen proportionally." },
    { label: "Stretch", desc: "Stretch wallpaper to fill your screen." },
    { label: "Center", desc: "Keep wallpaper centered without resizing." },
  ];
  ...
  return (
    <Modal
      ...
      hasBackdrop={false} // use custom blur overlay
      style={{
        margin: 0,
        justifyContent: "flex-start",
        alignItems: "flex-end", // Drawer appears at the right
      }}
    >
      {/* Custom Blur Overlay */}
      <BlurView
      ...
      {/* Drawer Panel */}
      <View
        className="bg-white h-full w-[90%] max-w-[656px] px-6 pt-6 pb-10 shadow-2xl"
        style={{
      ...
      >
        <ScrollView showsVerticalScrollIndicator={false}>
          ...
          {/* Display Mode */}
          <Text className="text-[20px] font-medium text-black mb-[8px]">
            Display Mode
          </Text>
            ...
            {displayModes.map((mode, index) => (
              <TouchableOpacity
                ...
                className={`p-4 flex-row items-center justify-between ${
                  index !== displayModes.length - 1 ? "border-b border-gray-200" : ""
                }`}
              >
                {/* Radio */}
                <View
                ...
                <View className="flex-1">
                  <Text className="text-[16px] text-black font-medium mb-[2px]">
                    {mode.label}
                  </Text>
          ...
          {/* Advanced Settings */}
          <Text className="text-[20px] font-medium text-gray-800 mb-[8px]">
            Advanced Settings
          </Text>
