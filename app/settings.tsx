...
const SettingsScreen = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main Container */}
      <View className="bg-gray-50 border border-gray-200 rounded-3xl p-6 md:p-10 flex-col md:flex-row md:items-center md:justify-between mt-[50px]">
        {/* Left Section */}
        <View className="w-full md:w-1/2">
          ...
          {/* Image Quality */}
          <View className="border border-gray-200 rounded-2xl mb-4">
          ...
          <View className="border border-gray-200 rounded-2xl mb-6 px-4 py-3 flex-row justify-between items-center">
            <View className="flex-1 pr-3">
              <Text className="font-semibold text-gray-700">Notification</Text>
